...
internal class S3ApkPluginOperations(val project: Project,
  ...
  override fun execute(variant: ApplicationVariant) {
    ...
    val productFlavourName = if (productFlavourNames.isEmpty()) "" else productFlavourNames.joinToString(
        "")
    ...
    if (zipAlignTask != null && variantData?.zipAlignEnabled ?: false) {
      ...
      log.warn(
          "Could not find zipAlign task, Did you specify signingConfig correctly for $variationName")
    }
  }
}